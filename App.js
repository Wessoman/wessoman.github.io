...
function discGet(artist) {
  ...
  $.ajax({
    ...
    if((resultsGet === undefined || resultsGet === null)||(resultsGet === "undefined" || resultsGet === "null")){
      $("#firstRow").addClass("d-none");
      $("#secondRow").addClass("d-none");
      $("#thirdRow").addClass("d-none");
      $("#noticeMeSenpai").removeClass("d-none");
...
$(document).ready(function(){
  results.addClass("d-none");
  $("#noticeMeSenpai").addClass("d-none");
  $("#tooCool").addClass("d-none");
});
...
$("#return").on("click", function(event){
  location.reload();
  database.ref().child("searchBand").update("");
});
